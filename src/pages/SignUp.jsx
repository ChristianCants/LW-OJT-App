            ...
            <div className="w-full lg:w-[40%] flex flex-col justify-center p-8 lg:p-20 relative z-10">
                <div className="max-w-md w-full mx-auto">
                    <div className="mb-10 text-center lg:text-left">
                        ...
                        <h1 className="text-4xl font-bold mb-3 tracking-tight">Sign up account</h1>
                        <p className="text-[#888] text-sm">Enter your personal data to create your account</p>
                    </div>
                    ...
                    <div className="mt-8 text-center text-sm text-[#888]">
                        ...
                        <Link to="/signin" className="text-white font-medium hover:underline">Log In</Link>
                    </div>
                </div>
            </div>
