...
import { customSignUp } from '../services';
                ...
                <div className="relative z-10 p-12 flex flex-col justify-between h-full w-full">
                    ...
                    <div className="mb-20">
                        ...
                        <h1 className="text-4xl xl:text-5xl font-bold text-white leading-tight drop-shadow-md mb-4">
                            Start your journey with global Data Engineering.
                        </h1>
                        <p className="text-white/80 text-sm max-w-lg drop-shadow-sm">
                            Join the team enabling AI solutions for enterprises worldwide.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div className="w-full max-w-md">
                    <div className="text-center mb-10">
                        ...
                        <p className="text-gray-600 text-sm mb-6">
                            Sign up to join the Lifewood OJT program.
                        </p>
                    ...
                    <form onSubmit={handleSignUp} className="space-y-4">
                        ...
                        <div className="text-xs text-gray-500">
                            By signing up, you agree to our <a href="#" className="underline hover:text-green-700">Terms</a> and <a href="#" className="underline hover:text-green-700">Privacy Policy</a>.
                        </div>
                    ...
                    <div className="mt-8 text-center text-sm text-gray-600">
                        ...
                        <Link to="/signin" className="text-[#153F2D] font-bold hover:underline">
                            Sign In
                        </Link>
                    </div>

                    <div className="mt-8 text-center text-[10px] text-gray-400">
                        © 2026 Lifewood Technologies.
                    </div>
                </div>
            </div>
        </div>
